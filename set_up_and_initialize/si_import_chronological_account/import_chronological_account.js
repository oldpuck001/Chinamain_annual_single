...
export async function import_chronological_account() {
    ...
    contentDiv.innerHTML = `
        ...
        <div class="import">
            ...
            <div>
                <label for="account_dateDropdown" style="width: 20%;">选择凭证日期列</label>
                <select id="account_dateDropdown" name="account_dateDropdown"></select>
            </div>

            <div>
                <label for="account_numberDropdown" style="width: 20%;">选择凭证字号列</label>
            ...
            <div>
                <label for="account_summaryDropdown" style="width: 20%;">选择摘要文本列</label>
                <select id="account_summaryDropdown" name="account_summaryDropdown"></select>
            </div>

            <div>
                <label for="account_debitDropdown" style="width: 20%;">选择借方金额列</label>
                <select id="account_debitDropdown" name="account_debitDropdown"></select>
            </div>

            <div>
                <label for="account_creditDropdown" style="width: 20%;">选择贷方金额列</label>
