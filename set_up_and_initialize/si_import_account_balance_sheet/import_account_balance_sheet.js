...
export async function import_account_balance_sheet() {
    ...
    contentDiv.innerHTML = `
        ...
        <div class="import">
            ...
            <div>
                <label style="width: 20%;">源数据文件</label>
                <input id="file_path" type="text">
            </div>

            <div>
                <label for="sheetDropdown" style="width: 20%;">选择工作表</label>
                <select id="sheetDropdown" name="sheetDropdown"></select>
            </div>

            <div>
                <label for="account_idDropdown" style="width: 20%;">选择科目代码列</label>
                <select id="account_idDropdown" name="account_idDropdown"></select>
            </div>

            <div>
                <label for="account_nameDropdown" style="width: 20%;">选择科目名称列</label>
                <select id="account_nameDropdown" name="account_nameDropdown"></select>
            </div>

            <div>
                <label for="begin_debitDropdown" style="width: 20%;">选择期初借方列</label>
                <select id="begin_debitDropdown" name="begin_debitDropdown"></select>
            </div>

            <div>
                <label for="begin_creditDropdown" style="width: 20%;">选择期初贷方列</label>
                <select id="begin_creditDropdown" name="begin_creditDropdown"></select>
            </div>

            <div>
                <label for="this_debitDropdown" style="width: 20%;">选择本期借方列</label>
                <select id="this_debitDropdown" name="this_debitDropdown"></select>
            </div>

            <div>
                <label for="this_creditDropdown" style="width: 20%;">选择本期贷方列</label>
                <select id="this_creditDropdown" name="this_creditDropdown"></select>
            </div>

            <div>
                <label for="end_debitDropdown" style="width: 20%;">选择期末借方列</label>
                <select id="end_debitDropdown" name="end_debitDropdown"></select>
            </div>

            <div>
                <label for="end_creditDropdown" style="width: 20%;">选择期末贷方列</label>
