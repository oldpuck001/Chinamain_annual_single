...
def import_balance_sheet(request):
    ...
    if assets_name == liabilities_name:
        ...
        #data_balance_sheet_df.rename(columns={assets_name: 'item', assets_previous: 'previous_year', assets_this: 'current_year'})
    else:
        ...
        #data_balance_sheet_df_assets.rename(columns={assets_name: 'item', assets_previous: 'previous_year', assets_this: 'current_year'})
        ...
        #data_balance_sheet_df_liabilities.rename(columns={liabilities_name: 'item', liabilities_previous: 'previous_year', liabilities_this: 'current_year'})
