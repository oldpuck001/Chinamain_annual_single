...
export async function import_balance_sheet() {
    ...
    contentDiv.innerHTML = `
        ...
        <div class="import">
            ...
            <div>
                <label style="width: 22%;">源数据文件</label>
                <input id="file_path" type="text">
            </div>

            <div>
                <label for="sheetDropdown" style="width: 22%;">选择工作表</label>
                <select id="sheetDropdown" name="sheetDropdown"></select>
            </div>

            <div>
                <label for="assets_nameDropdown" style="width: 22%;">选择资产项目名称列</label>
            ...
            <div>
                <label for="assets_thisDropdown" style="width: 22%;">选择资产本期期末列</label>
            ...
            <div>
                <label for="assets_previousDropdown" style="width: 22%;">选择资产本期期初列</label>
            ...
            <div>
                <label for="liabilities_nameDropdown" style="width: 22%;">选择负债权益名称列</label>
            ...
            <div>
                <label for="liabilities_thisDropdown" style="width: 22%;">选择负债权益本期期末列</label>
            ...
            <div>
                <label for="liabilities_previousDropdown" style="width: 22%;">选择负债权益本期期初列</label>
